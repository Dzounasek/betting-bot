...
st.set_page_config(page_title="Value Bot v5.5", layout="wide")
 
st.title("⚽ Betting Bot v5.5 PRO + Kelly + Tiket")
...
with st.sidebar:
    ...
    # =========================================================
    # 🎟️ TIKET PANEL — trvale viditelný v sidebaru
    # =========================================================
    st.divider()
...
if st.session_state.show_results:
    ...
    def add_to_ticket(label, prob, user_odds, stake_czk, ev):
        ...
        # Zkontroluj duplicitu (stejný label)
    ...
    def display_market(label, prob):
        ...
        # 4 sloupce: název, kurz bookmaker, výsledek kelly + návrat, tlačítko +
