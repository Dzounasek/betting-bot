...
st.set_page_config(page_title="Value Bot v5.9 PRO", layout="wide")
...
with st.sidebar:
    ...
    if len(st.session_state.ticket) == 0:
        ...
        for idx, bet in enumerate(st.session_state.ticket):
            ...
            # Simulace pro každou sázku (Monte Carlo)
        ...
        # Pravděpodobnost zisku (kolikrát skončí simulace nad 0)
...
# =========================================================
st.title("⚽ Betting Bot v5.9 PRO + Smart Tipovačka")
st.markdown("Vylepšená AI, Smart skóre a tiket s bankrollem hezky vlevo.")
